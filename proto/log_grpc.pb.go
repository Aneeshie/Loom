...
const (
	...
	LogService_SimilarLogs_FullMethodName = "/loom.v1.LogService/SimilarLogs"
)
...
type LogServiceClient interface {
	...
	SimilarLogs(ctx context.Context, in *SimilarLogsRequest, opts ...grpc.CallOption) (*GetLogsResponse, error)
}
...
func (c *logServiceClient) SimilarLogs(ctx context.Context, in *SimilarLogsRequest, opts ...grpc.CallOption) (*GetLogsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetLogsResponse)
	err := c.cc.Invoke(ctx, LogService_SimilarLogs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LogServiceServer interface {
	...
	SimilarLogs(context.Context, *SimilarLogsRequest) (*GetLogsResponse, error)
...
func (UnimplementedLogServiceServer) SimilarLogs(context.Context, *SimilarLogsRequest) (*GetLogsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SimilarLogs not implemented")
}
...
func _LogService_SimilarLogs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SimilarLogsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LogServiceServer).SimilarLogs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LogService_SimilarLogs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogServiceServer).SimilarLogs(ctx, req.(*SimilarLogsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LogService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "loom.v1.LogService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SimilarLogs",
			Handler:    _LogService_SimilarLogs_Handler,
		},
	},
